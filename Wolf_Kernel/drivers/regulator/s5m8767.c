...
/* //Robin, only for test..
	...
	*/
	...
	mdelay(300);
	#endif
	//Robin Wang, 2012.2.7, Don't Power On the WIFI chip temporary. Must Power on later.
       //Because when wifi is on,there is one issue in wakeup/sleep
	gpio_set_value(EXYNOS4_GPZ(5), 1);
	
	// END_SEMCO_A31 WiFi/BT
