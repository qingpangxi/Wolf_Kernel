...
#ifdef CONFIG_WOLF_LEDS_CTL
struct platform_device s3c_device_wolf_leds_ctl = {
	.name   = "wolf_leds",
	.id             = -1,
};
#endif
...
#ifdef CONFIG_WOLF_BEEP_CTL
struct platform_device s3c_device_wolf_beep_ctl = {
        .name   = "wolf_beep",
        .id             = -1,
};
#endif
...
#ifdef CONFIG_WOLF_ADC_CTL
struct platform_device s3c_device_wolf_adc_ctl = {
	.name			= "wolf_adc",
	.id				= -1,
};
#endif
