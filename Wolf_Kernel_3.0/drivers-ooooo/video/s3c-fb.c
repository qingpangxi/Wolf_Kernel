...
//yulu
#if 1//defined(CONFIG_LCD_WA101S)
...
int s3cfb_backlight_en(/*struct platform_device *pdev*/void)
{
	int err;
...
//	s3c_gpio_cfgpin(EXYNOS4_GPD0(1), EXYNOS4_GPD_0_2_TOUT_2);
...
#else
	//DC33_EN
	err = gpio_request(EXYNOS4_GPK1(0), "GPK1_0");
	if (err) {
...
{
printk("fb:11111111111111111111111111111\n");
